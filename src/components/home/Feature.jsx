...
import MaritimeCity from "../../assets/MaritimeCity (1).webp"
    ...
    <>
      <section className='text-white px-[156px] py-[128px]'>
        <div className='mx-auto flex flex-col gap-12 md:gap-24'>
          ...
          <div className='md:w-[500px] self-end text-xs md:text-sm leading-relaxed text-gray-secondary'>
            <p className='mb-2'>
      ...
      <section className=''>
        <div className=''>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 md:grid-rows-2 gap-1 bg-section-dark overflow-hidden'>
            {values.map((item) => (
              <div
                key={item.id}
                className={`bg-card-dark p-8 flex rounded-md overflow-hidden flex-col gap-16 justify-between transition-all duration-300 ease-out transform  hover:shadow-xl hover:bg-card-hover ${item.tall ? 'md:row-span-2' : ''
                  }`}
              >
                <div className='w-1/2'>
                  ...
                  <p className='text-xs md:text-sm text-gray-secondary max-w-xs'>
                    {item.description}
                  </p>
                </div>
