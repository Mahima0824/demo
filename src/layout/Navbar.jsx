        ...
        <header className="fixed top-0 left-0 right-0 z-50">
            <nav className=" px-7 py-3 backdrop-blur-2xl md:py-5 bg-transparent">
                <div className="flex  items-center justify-between">
                    ...
                    <div className="relative flex justify-center items-center gap-4 w-28">
                        <button
                            type="button"
                            onClick={toggle}
                            aria-haspopup="menu"
                            aria-expanded={open}
                            className="flex flex-row justify-between items-center gap-4 rounded-[3px] bg-[rgba(248,249,251,0.1)] px-4 py-2 text-xs font-medium text-white/90 cursor-pointer relative w-full backdrop-blur-sm ring-1 ring-white/20 hover:bg-white/15"
                        >
                            {lang}
                            <svg width={12} height={6} viewBox="0 0 12 6" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 0.5L6 5.5L11 0.5" stroke="currentColor" strokeLinejoin="bevel"></path></svg>
                        </button>

                        {open && (
                            <div
                                role="menu"
                                className="absolute right-0 mt-2 w-28 origin-top-right rounded-md bg-neutral-900/90 backdrop-blur ring-1 ring-white/10 shadow-lg focus:outline-none z-20"
                            >
